    ...
    while True:
        ...
        for box in boxes:
            ...
            if timestamp <= cap.get(cv2.CAP_PROP_POS_MSEC):
                left = int(box['BoundingBox']['Left'] * img_width)
                top = int(box['BoundingBox']['Top'] * img_height)
                right = int((box['BoundingBox']['Left'] +
                            box['BoundingBox']['Width']) * img_width)
                bottom = int((box['BoundingBox']['Top'] +
                              box['BoundingBox']['Height']) * img_height)
